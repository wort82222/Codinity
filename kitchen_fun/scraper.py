"""
Kitchen Fun Scraper - Complete Production Version
Scrapes https://www.sheeel.com/ar/kitchen-fun.html with pagination
...
class KitchenFunScraper:
    def __init__(self, s3_bucket=None, aws_access_key=None, aws_secret_key=None):
        self.base_url = "https://www.sheeel.com/ar/kitchen-fun.html"
        self.category = "kitchen_fun"
        self.products = []
    ...
    def scrape_all_pages(self):
        ...
        print("\n" + "="*70)
        print("🚀 KITCHEN FUN SCRAPER - WITH PAGINATION")
        print("="*70)
        print(f"\nURL: {self.base_url}\n")
    ...
    def save_to_excel(self, include_s3_paths=False):
        ...
        filename = f"kitchen_fun_{timestamp}.xlsx"
    ...
    def upload_results_to_s3(self):
        ...
        # Save locally
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"kitchen_fun_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("🍳 KITCHEN FUN SCRAPER - PRODUCTION")
        print("="*70)
