"""
Last Pieces Scraper - Cloudflare R2 Version
Scrapes https://www.sheeel.com/ar/last-pieces.html with pagination
...
class LastPiecesScraper:
    def __init__(self, r2_bucket=None, cf_access_key=None, cf_secret_key=None, cf_endpoint_url=None):
        self.base_url = "https://www.sheeel.com/ar/last-pieces.html"
        self.category = "last_pieces"
        self.products = []
    ...
    def scrape_all_pages(self):
        print("\n" + "="*70)
        print("🚀 LAST PIECES SCRAPER - WITH PAGINATION")
        print("="*70)
        print(f"\nURL: {self.base_url}\n")
    ...
    def save_to_excel(self, include_r2_paths=False):
        ...
        filename = f"last_pieces_{timestamp}.xlsx"
    ...
    def upload_results_to_r2(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"last_pieces_{timestamp}.xlsx"
    ...
    def run(self):
        print("\n" + "="*70)
        print("🏷️  LAST PIECES SCRAPER - CLOUDFLARE R2")
        print("="*70)
