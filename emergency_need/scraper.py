"""
Emergency Needs Scraper - Complete Production Version
Scrapes https://www.sheeel.com/ar/emergency-needs.html with pagination
...
class EmergencyNeedsScraper:
    def __init__(self, s3_bucket=None, aws_access_key=None, aws_secret_key=None):
        self.base_url = "https://www.sheeel.com/ar/emergency-needs.html"
        self.category = "emergency_need"
        self.products = []
    ...
    def scrape_all_pages(self):
        ...
        print("\n" + "="*70)
        print("🚀 EMERGENCY NEEDS SCRAPER - WITH PAGINATION")
        print("="*70)
        print(f"\nURL: {self.base_url}\n")
    ...
    def save_to_excel(self, include_s3_paths=False):
        ...
        filename = f"emergency_needs_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("🏥 EMERGENCY NEEDS SCRAPER - PRODUCTION")
        print("="*70)
